...
LOCAL_PATH := device/samsung/arndaleocta

PRODUCT_CHARACTERISTICS := tablet
DEVICE_PACKAGE_OVERLAYS += device/samsung/arndaleocta/overlay
...
$(call inherit-product, vendor/samsung/arndaleocta/arndaleocta-vendor.mk)
